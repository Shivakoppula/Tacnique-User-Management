 ...
 async function handleDelete() {
  ...
  function handleLogout() {
    ...
    <div className="mx-auto my-[35px] w-[95%] max-w-[1450px] max-md:my-5 max-md:w-[96%]">
      ...
      {loading && (
        <div className="mt-[25px] rounded-[20px] bg-white p-10 text-center shadow-[0_12px_30px_rgba(0,0,0,.08)]">
          <h2>Loading Users...</h2>
        </div>
      )}

      {!loading && error && (
        <div className="mt-[25px] rounded-[20px] bg-white p-10 text-center text-[#ef4444] shadow-[0_12px_30px_rgba(0,0,0,.08)]">
          <h3>{error}</h3>
        </div>
      )}
