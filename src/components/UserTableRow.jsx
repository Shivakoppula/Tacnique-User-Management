    ...
    <tr className="transition duration-350 even:bg-[#fafcff] hover:scale-[1.003] hover:bg-[#eef5ff]">
      ...
      <td className="border-b border-[#edf2f7] p-[18px] text-center text-[15px]">
        ...
        <div className="flex items-center justify-center gap-3 max-md:flex-col">
          ...
          <button
            className="cursor-pointer rounded-[10px] border-0 bg-[linear-gradient(135deg,#10b981,#059669)] px-[18px] py-2.5 text-sm font-semibold text-white brightness-100 transition-[transform,box-shadow,filter] duration-350 ease-in-out hover:-translate-y-[3px] hover:brightness-75 hover:shadow-[0_15px_25px_rgba(16,185,129,.28)] active:scale-[.96] max-md:w-full"
            onClick={() => onEdit(user)}
            title="Edit User"
          >
            ✏ Edit
          ...
          <button
            className="cursor-pointer rounded-[10px] border-0 bg-[linear-gradient(135deg,#ef4444,#dc2626)] px-[18px] py-2.5 text-sm font-semibold text-white brightness-100 transition-[transform,box-shadow,filter] duration-350 ease-in-out hover:-translate-y-[3px] hover:brightness-75 hover:shadow-[0_15px_25px_rgba(239,68,68,.3)] active:scale-[.96] max-md:w-full"
